...
{
    public class ExceptionHandleRecordsController : Controller
    {
        //
        // GET: /person/ExceptionHandleRecords/
        ...
        {
            return this.Store(new ExceptionHandleRecordsModel().Select(date, name).GetPage(parameters));
        }
    }
}
